...
public class CadastroClienteJDialog extends javax.swing.JDialog {

    public CadastroClienteJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroClienteJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroClienteJDialog dialog = new CadastroClienteJDialog(new javax.swing.JFrame(), true);
